...
- [DEVELOPMENT.md](./DEVELOPMENT.md) - Coding standards and best practices
- [guides/adding-new-features.md](./guides/adding-new-features.md) - Feature implementation process
- [guides/testing-guidelines.md](./guides/testing-guidelines.md) - Testing requirements
...
**See [DEVELOPMENT.md](./DEVELOPMENT.md) for complete coding standards.**
...
**See [guides/testing-guidelines.md](./guides/testing-guidelines.md) for details.**
...
- **Real-time discussion:** (Add project chat link if available)
