...
impl SecureGlobalContext {
    ...
    fn setup_route_registry(
        ...
        // 6b. generateOpenApi function — delegates to the shared engine
        // implementation (also served natively at /engine/openapi.json)
        ...
        let generate_openapi = Function::new(
            ...
            move |_ctx: rquickjs::Ctx<'_>| -> JsResult<String> {
                ...
                Ok(crate::engine_api::generate_merged_openapi_spec())
            },
        )?;
