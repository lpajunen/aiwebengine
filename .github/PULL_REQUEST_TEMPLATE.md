...
- [ ] Code documentation (doc comments) added/updated
- [ ] Feature guide updated (in `docs/engine-contributors/implementing/features/`)
- [ ] User documentation updated (in `docs/`)
- [ ] ROADMAP.md updated (if applicable)
- [ ] Example scripts added (if applicable)
...
- [ ] Code reviewed by myself for quality
